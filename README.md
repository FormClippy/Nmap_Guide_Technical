...
# 📖 คู่มือ Nmap   
# 🎯 สรุป Target Specification (การระบุเป้าหมาย)
...
- [🌐 Nmap Overview](#nmap-overview)
  - [🎯 สแกน IP เดี่ยว](#-1-nmap-your-target-สแกน-ip-เดี่ยว)
  - [🌍 สแกนโดเมนเนม](#=2-สแกน-domain-name-ด้วย-nmap-domain)
  - [🏘️ สแกน Subnet](#3-nmap-subnet-สแกนยกซับเน็ตด้วย-cidr)
  - [📂 สแกนจากไฟล์](#4-nmap--il-iptxt-สแกนจากไฟล์รายการเป้าหมาย)
...
```
> ทำ scope agreement กับล customer เสมอ → บอกก่อนว่าจะยิง subnet ใหญ่ และอาจมี traffic เยอะ
